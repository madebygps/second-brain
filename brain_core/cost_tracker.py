...
class LLMUsage:
    ...
    entry_date: Optional[str] = None  # For operations tied to specific entries
...
class CostTracker:
    ...
    def export_data(self, start_date: Optional[date] = None, end_date: Optional[date] = None) -> List[Dict]:
